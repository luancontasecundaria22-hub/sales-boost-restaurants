          ...
          plans: [
            {
              ...
              period: '/mês',
              popular: false,
              features: ['1 restaurante', 'Relatório mensal completo', 'Análise de reviews com IA', 'Mapeamento de 5 concorrentes'],
            },
            {
              name: 'Pro',
              price: 'R$697',
              period: '/mês',
              popular: true,
              features: ['Tudo do Starter', 'Perfil de clientes (QR code)', 'Alertas de reviews em tempo real', 'Respostas automáticas a reviews'],
            },
            {
              name: 'Ultra',
              price: 'R$799',
              period: '/mês',
              popular: false,
              features: ['Tudo do Pro', 'Até 3 restaurantes', 'Análise preditiva de tendências', 'Relatório white-label compartilhável', 'Suporte dedicado'],
            },
          ],
        },
        us: {
          ...
          plans: [
            {
              ...
              period: '/mo',
              popular: false,
              features: ['1 restaurant', 'Full monthly report', 'AI-powered review analysis', '5 competitor mapping'],
            },
            {
              name: 'Pro',
              price: '$397',
              period: '/mo',
              popular: true,
              features: ['Everything in Starter', 'Customer profile (QR code)', 'Real-time review alerts', 'Automatic review replies'],
            },
            {
              name: 'Ultra',
              price: '$499',
              period: '/mo',
              popular: false,
              features: ['Everything in Pro', 'Up to 3 restaurants', 'Predictive trend analysis', 'White-label shareable report', 'Dedicated support'],
            },
          ],
        },
      },
