...
export default function SettingsPage() {
  ...
  const tabFromParam = (v: string | null): 'info' | 'integrations' =>
    v === 'integracoes' ? 'integrations' : 'info'
  const [tab, setTab] = useState<'info' | 'integrations'>(tabFromParam(searchParams.get('tab')))

  useEffect(() => {
    const paramTab = searchParams.get('tab')
    if (paramTab === 'integracoes') setTab(tabFromParam(paramTab))
